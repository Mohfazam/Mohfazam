...
- [Hired Hub](https://hired-hub-nu.vercel.app/):A platform that tracks job applications and auto-applies for specific jobs across platforms like LinkedIn and Naukri.
- [Web Based Crypto Wallet](https://punk-crypto-wallet.vercel.app):  A crypto wallet with key-pair generation and transaction interface, ready for blockchain integration.
